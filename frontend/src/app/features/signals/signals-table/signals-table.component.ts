...
@Component({
  ...
  standalone: true,
  imports: [DatePipe, MatTableModule, SignalTypePipe, StageBadgePipe, ScoreBarComponent, StatusBadgeComponent],
...
export class SignalsTableComponent {
  ...
  displayedColumns = ['ticker', 'stage', 'signal_type', 'score', 'acted_on', 'created_at'];
}
